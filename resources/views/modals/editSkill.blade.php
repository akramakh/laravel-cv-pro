    <div class="modal-content" style="width:auto;">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" role="modal">
          ...
          <div class="form-group row col-sm-12">
            ...
            <input type="name" class="form-control col-sm-10" id="skill_name_in" value="{{$name}}" disabled>
          </div>

          <div class="form-group row col-sm-12">
            <label class="control-label col-sm-2"for="body">Score</label>
            <textarea type="name" class="form-control col-sm-10 skill_score_in" id="skill_score_in">{{$score}}</textarea>
          </div>
        </form>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary actionBtn" onclick="updateSkill({{$id}} ,90 )">
