...
<div class="modal-content" style="width:auto;">
            ...
            <form class="form-horizontal" role="modal">
              ...
              <div class="form-group row col-sm-12">
                <label class="control-label col-sm-2"for="id">ID</label>
                  <input type="text" class="form-control col-sm-10" id="language_id_in" value="{{$language->id}}" disabled>
              </div>

              <div class="form-group row col-sm-12">
                <label class="control-label col-sm-2"for="title">Name</label>
                <input type="name" class="form-control col-sm-10" id="language_name_in" value="{{$language->name}}" >
              </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary actionBtn" onclick="updateLanguage({{$language->id}})">
