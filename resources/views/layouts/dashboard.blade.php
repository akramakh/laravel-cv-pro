...
<head>
    <meta charset="utf-8" />
    <title>Metronic Admin Theme #2 | Calendar</title>
    ...
    <link href="Dashboard/assets/layouts/layout2/css/layout.min.css" rel="stylesheet" type="text/css" />
    <link href="Dashboard/assets/layouts/layout2/css/themes/blue.min.css" rel="stylesheet" type="text/css" id="style_color" />
    <link href="Dashboard/assets/layouts/layout2/css/custom.min.css" rel="stylesheet" type="text/css" />
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="Dashboard/assets/layouts/layout2/img/logo-default.png" alt="logo" class="logo-default" /> </a>
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle" src="{{$user->info != null ? asset('img/'.$user->info->personal_photo) : 'img/defualt_personal_photo.jpg' }}" />
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        <li class="nav-item start active open">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item start active open">
                                    <a href="/admin/dashboard_1" class="nav-link ">
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar1.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar4.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar2.jpg" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar6.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar7.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar8.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar9.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar10.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="Dashboard/assets/layouts/layout/img/avatar11.jpg" alt="...">
                                        <div class="media-body">
                            ...
                            <div class="page-quick-sidebar-item">
                                <div class="page-quick-sidebar-chat-user">
                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="Dashboard/assets/layouts/layout/img/avatar3.jpg" />
                                            <div class="message">
                                                <span class="arrow"></span>
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="Dashboard/assets/layouts/layout/img/avatar2.jpg" />
                                            <div class="message">
                                                <span class="arrow"></span>
...
<div class="page-footer">
    <div class="page-footer-inner"> 2018 &copy; CV Pro
        <a target="_blank" href="#">Akram A KH</a> &nbsp;|&nbsp;
        <a href="#" title="Akram Abu Khousa" target="_blank">CV Pro!</a>
    ...
    <script src="Dashboard/assets/global/plugins/ie8.fix.min.js"></script>
    <![endif]-->
    <!-- BEGIN CORE PLUGINS -->
    ...
    <script src="Dashboard/assets/global/plugins/js.cookie.min.js" type="text/javascript"></script>
    ...
    <script src="Dashboard/assets/global/plugins/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL PLUGINS -->
    <!-- BEGIN THEME GLOBAL SCRIPTS -->
    <script src="Dashboard/assets/global/scripts/app.min.js" type="text/javascript"></script>
    <!-- END THEME GLOBAL SCRIPTS -->
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
    <script src="Dashboard/assets/apps/scripts/calendar.min.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <!-- BEGIN THEME LAYOUT SCRIPTS -->
    <script src="Dashboard/assets/layouts/layout2/scripts/layout.min.js" type="text/javascript"></script>
    <script src="Dashboard/assets/layouts/layout2/scripts/demo.min.js" type="text/javascript"></script>
    <script src="Dashboard/assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
    <script src="Dashboard/assets/layouts/global/scripts/quick-nav.min.js" type="text/javascript"></script>
...
//       $('.post' + $('.id').text()).remove();
    ...
    function updateSkill(id){
        removeAlert();
        var name = $('#skill_name_in');
        $.ajax({
            method: 'POST',
            url: 'admin/update-skill/',
            dataType: 'html',
            data: {
                '_token': "{{ csrf_token() }}",
                'id': id,
